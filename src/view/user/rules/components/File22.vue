...
<essayTextWithWeight>1.2.1</essayTextWithWeight> 本办法适用于入驻营探的全部服务商；

<essayTextWithWeight>1.2.2</essayTextWithWeight> 以人民币进行交易的支付结算适用本办法，外币结算业务暂不涉及。 
...
<essayTextWithWeight>1.3.3</essayTextWithWeight> 【规则】指营探发布的协议、规则、实施细则、解读、说明、公告、政策、声明等内容。发布渠道包括但不限于营探规则中心、帮助中心、站内信通知、邮件通知、短信通知等。 

<essayTextWithWeight>1.3.4</essayTextWithWeight> 【用户】指使用营探平台，包括但不限于注册用户及非注册用户，凡未注册的用户自开始使用本平台的商品和服务时，即成为我们的非注册用户。在使用过程中须遵循本协议中除注册用户专属约定以外的其他所有条款。 

<essayTextWithWeight>1.3.5</essayTextWithWeight> 【服务商】指成为营探用户后，依据平台要求申请入驻营探并通过审核，在营探发布商品的自然人、法人和非法人组织，独立经营并自负盈亏。服务商在使用平台服务过程中须遵循本协议及其他相关规则。 

<essayTextWithWeight>1.3.6</essayTextWithWeight> 【第三方】指与营探合作的，为营探用户提供专业商业服务的其他经营者。 

<essayTextWithWeight>1.3.7</essayTextWithWeight> 【第三方服务】指由第三方提供的商品和服务，该商品和服务包括但不限于在营探平台由第三方提供的链接、信息或服务，该第三方提供的服务包括但不限于：保险服务、支付服务、财税服务。 

<essayTextWithWeight>1.3.8</essayTextWithWeight> 【交易金额】指使用优惠促销等权益或优惠后成交的、无退款的实际支付金额；该交易额的核算时点为季度最后一天零点，未完成的在途交易不在计提范围内。 

<essayTextWithWeight>1.3.9</essayTextWithWeight> 【费用】指营探为服务商提供平台服务所收取的各项费用，包括营探确认收入的费用和服务商委托营探进行代扣代缴的费用等。 

<essayTextWithWeight>1.3.10</essayTextWithWeight> 【核算】指营探按照约定周期，以人民币为计量单位，通过确认、计量、记录和报告等环节,对服务商的经营活动收入进行记账、报账和算账。 

<essayTextWithWeight>1.3.11</essayTextWithWeight> 【核算期】指营探核算周期，包括以月度核算、季度核算、半年度核算和年度核算；每个周期（自每个周期第一天至最后一自然日24点）核算的实际交易金额，不包括未完成的在途交易。 

<essayTextWithWeight>1.3.12</essayTextWithWeight> 【结算】指营探按照约定对经济往来过程中使用电子支付、票据、信用卡、汇兑和委托收款等结算方式实行货币给付及其资金清算的行为。 
...
<essayTextWithWeight>3.1.2</essayTextWithWeight> 营探通过向服务商、第三方在银行或相关有资质的金融机构开立的存款账户办理支付结算；

<essayTextWithWeight>3.1.3</essayTextWithWeight> 营探严格履行我国法律的规定，仅可向入驻服务商所持有的指定账户进行支付结算；
...
<essayTextWithWeight>3.2.2</essayTextWithWeight> 支付结算前，服务商、第三方须向营探提供对应期间、对应结算订单的发票； 
...
<essayTextWithWeight>3.3.2</essayTextWithWeight> 谁的钱进谁的账，由谁支配； 
...
<essayTextWithWeight>3.4.2</essayTextWithWeight> 服务商委托营探向第三方完成收款结算的，必须经营探同意，且该费用必须是与发布商品相关的费用；除此之外，营探不支持代服务商向其他公司/个人委托支付/收入款项。 
...
<essayTextWithWeight>3.7.2</essayTextWithWeight> 服务商应付款项逾期付款，应按照规定承担赔偿责任；服务商变更开户银行、账户名称和账号，未能及时通知营探，影响收取款项的，应由服务商承担。
...
（2）消费者未确认订单完成但服务商活动已结束，系统将在服务商活动结束后第三（3）日自动"确认订单完成"后； 

（3）系统识别为异常的其他周期结束后。 

<essayTextWithWeight>3.8.2</essayTextWithWeight>  最小结算单位

交易金额的结算以单个商品的单个团期为最小结算单位，多团期的商品以每一团期为单位进行交易金额结算。
...
<essayTextWithWeight>3.11.2</essayTextWithWeight> 服务商同意并理解，营探有可能因网络问题或银行问题，造成结算迟延；非因网路或不可抗力的原因，营探有义务按约定向服务商支付提现款项。
...
<essayTextWithWeight>4.1.2</essayTextWithWeight> 按月计算期限的，按到期月的对日计算；无对日的，月末日为到期日；
